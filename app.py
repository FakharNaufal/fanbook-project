...
# pada route ('/') atau home akan memanggil, lalu menampilkan file index.html yang terdapat pada folder templates
@app.route('/')
def home():
...
def bucket_post():
    ...
    # variable untuk membuat nilai yang unik pada setiap datanya agar lebih presisi saat akan dipakai untuk parameter dalam menjalankan function di sisi client
